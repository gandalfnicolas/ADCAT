...
#'
#'
#' @format A data frame with 14449 rows and 981 variables:
#' \describe{
...
#'   ...
#' }
"Unprocessed_Dictionaries.ftshort"
...
#' Word embeddings for expanded dictionaries
#'
#' Word embeddings for expanded dictionaries
#'
#'
